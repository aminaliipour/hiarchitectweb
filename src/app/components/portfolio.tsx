...
export default function Portfolio() {
  ...
  const projects = [
    // تجاری
    {
      ...
      category: "تجاری",
      image: "/api/images/projects/تجاری/آزمایشگاه رحمانی/01(1).jpg",
      images: getProjectImages("/api/images/projects/تجاری/آزمایشگاه رحمانی", [
    ...
    },
    {
      ...
      title: "آوین گلد",
      category: "تجاری", 
      image: "/api/images/projects/تجاری/آوین گلد/2025_06_28_11_25_IMG_7151.JPG",
      images: getProjectImages("/api/images/projects/تجاری/آوین گلد", [
    ...
    },
    {
      ...
      title: "بوتیک لنا",
      category: "تجاری",
      image: "/api/images/projects/تجاری/بوتیک لنا/IMG_0538.JPG",
      images: getProjectImages("/api/images/projects/تجاری/بوتیک لنا", [
    ...
    },
    {
      ...
      category: "تجاری",
      image: "/api/images/projects/تجاری/سالن زیبایی نگار حیدری/IMG_1356.JPG",
      images: getProjectImages("/api/images/projects/تجاری/سالن زیبایی نگار حیدری", [
    ...
    },
    {
      ...
      title: "گل از ماهان",
      category: "تجاری",
      image: "/api/images/projects/تجاری/گل از ماهان/1.jpg",
      images: getProjectImages("/api/images/projects/تجاری/گل از ماهان", [
    ...
    },
    {
      ...
      title: "Lbeauty",
      category: "تجاری",
      image: "/api/images/projects/Lbeauty/1755078869611-gzxegc.jpg",
      images: getProjectImages("/api/images/projects/Lbeauty", [
        "1755078869611-gzxegc.jpg", "1755078752901-1-24.jpg", "1755078829494-jcu9kr.jpg", 
        "1755078846470-q46bbj.jpg", "1755078864698-d4vtf0.jpg", "1755078835263-l5ljlx.jpg",
        "1755078856754-t1vf6v.jpg", "1755078823721-i4pusa.jpg", "1755078816991-66c6jd.jpg",
        "1755078805381-uvua8y.jpg", "1755078811950-by222a.jpg"
      ]),
      description: "سالن زیبایی مدرن با طراحی لوکس و فضای آرامش‌بخش",
    },
    ...
    // مسکونی
    {
      ...
      title: "مسکونی دانش",
      category: "مسکونی",
      image: "/api/images/projects/مسکونی/مسکونی دانش/1.jpg",
      images: getProjectImages("/api/images/projects/مسکونی/مسکونی دانش", [
    ...
    },
    {
      ...
      category: "مسکونی",
      image: "/api/images/projects/مسکونی/مسکونی کارگر14/1 (1).jpg",
      images: getProjectImages("/api/images/projects/مسکونی/مسکونی کارگر14", [
    ...
    // ویلایی
    {
      ...
      category: "ویلایی",
      image: "/api/images/projects/ویلایی/محوطه ویلا ساحل/IMG_7453.jpeg",
      images: getProjectImages("/api/images/projects/ویلایی/محوطه ویلا ساحل", [
    ...
    },
    {
      ...
      title: "ویلا فدایی",
      category: "ویلایی",
      image: "/api/images/projects/ویلایی/ویلا فدایی/1.jpg",
      images: getProjectImages("/api/images/projects/ویلایی/ویلا فدایی", [
        "1.jpg", "2.jpg", "3.jpg", "4.jpg", "5.jpg", "6.jpg"
      ]),
    ...
    },
    {
      ...
      title: "ویلا گلپور",
      category: "ویلایی",
      image: "/api/images/projects/ویلایی/ویلا گلپور/1.jpg",
      images: getProjectImages("/api/images/projects/ویلایی/ویلا گلپور", [
  ...
  const spotlightProjects = [
    ...
    },
    {
      id: 4,
      title: "Lbeauty",
      description: "سالن زیبایی مدرن با طراحی لوکس و فضای آرامش‌بخش که تجربه‌ای بی‌نظیر از خدمات زیبایی ارائه می‌دهد.",
      image: "/api/images/projects/Lbeauty/1755078869611-gzxegc.jpg",
      details: "تکمیل‌شده در ۱۴۰۳ • تجاری • طراحی داخلی",
    },
  ]
