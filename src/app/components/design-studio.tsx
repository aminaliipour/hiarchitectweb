    ...
    <section id="design-studio" className="relative bg-gray-950 py-24 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        <div className="fixed bottom-8 left-8 z-50">
          <motion.a
            href={SEO_CONSTANTS.SOCIAL_MEDIA.TELEGRAM}
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            className="flex h-16 w-16 items-center justify-center rounded-full bg-yellow-500 text-black shadow-lg hover:bg-yellow-400 transition-colors"
            title="چت در تلگرام"
          >
